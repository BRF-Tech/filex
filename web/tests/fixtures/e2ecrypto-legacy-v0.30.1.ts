...
//
// This is packages/core/src/lib/e2ecrypto.ts exactly as it shipped in
// v0.30.1, before folder recovery keys existed. It is a test fixture, not
// live code: the round-trip suite encrypts with THIS module and decrypts
// with the current one, so "already-encrypted folders keep opening" is
// measured against the real old implementation rather than against a
// re-creation of it from memory.
//
// Taken from commit 5a4095d (chore(release): v0.30.1).
