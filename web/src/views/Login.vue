      ...
      <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
          ...
          <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <a class="text-brand-600 dark:text-brand-400 hover:underline" href="https://gitlab.com/brftech/filemanager" target="_blank" rel="noopener">gitlab.com/brftech/filemanager</a>
          </p>
        </div>
      </div>
