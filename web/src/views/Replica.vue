...
import { GitBranch, RefreshCcw, Wrench, Plus, Save, Trash2, FileText, Settings as SettingsIcon, ListTree } from 'lucide-vue-next';
...
async function loadAll() {
  ...
  try {
    await Promise.all([replica.fetchRules(), replica.fetchFailures(), replica.fetchReport(), replica.fetchSettings()]);
