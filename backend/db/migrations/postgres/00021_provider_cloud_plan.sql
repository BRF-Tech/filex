...
ALTER TABLE providers ADD COLUMN IF NOT EXISTS plan TEXT;
ALTER TABLE providers ADD COLUMN IF NOT EXISTS limits_json TEXT;
ALTER TABLE providers ADD COLUMN IF NOT EXISTS billing_ref TEXT;

-- +goose Down
ALTER TABLE providers DROP COLUMN IF EXISTS billing_ref;
ALTER TABLE providers DROP COLUMN IF EXISTS limits_json;
ALTER TABLE providers DROP COLUMN IF EXISTS plan;
