...
/** Directory-like, read-only preview for every server-supported archive. */
...
.filex-viewer-archive__entry { display: inline-flex; align-items: center; max-width: 100%; border: 0; background: transparent; color: inherit; font: inherit; padding: 0; text-align: left; }
