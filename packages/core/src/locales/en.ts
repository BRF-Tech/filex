...
export const en: Record<string, string> = {
  ...
  'modal.delete.permanent_title': 'Delete permanently?',
  'modal.delete.permanent_message': '{count} items will be deleted for good. This cannot be undone.',
  'modal.delete.permanent_message_one': '{count} item will be deleted for good. This cannot be undone.',
  'modal.delete.permanent_confirm': 'Delete permanently',
  'modal.delete.permanent_working': 'Deleting…',
  ...
  'toast.undo_queued': 'The undo is on its way — the operations panel says when it is done',
  ...
  'toast.purged_partly_one': '{n} item deleted permanently; {failed} could not be',
  ...
  'coverage.catalog_failed': 'Cataloging {storage} failed: {error}',
