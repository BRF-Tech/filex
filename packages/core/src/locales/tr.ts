...
export const tr: Record<string, string> = {
  ...
  'modal.delete.permanent_title': 'Kalıcı olarak silinsin mi?',
  'modal.delete.permanent_message': '{count} öğe kalıcı olarak silinecek. Bu geri alınamaz.',
  'modal.delete.permanent_message_one': '{count} öğe kalıcı olarak silinecek. Bu geri alınamaz.',
  'modal.delete.permanent_confirm': 'Kalıcı olarak sil',
  'modal.delete.permanent_working': 'Siliniyor…',
  ...
  'toast.undo_queued': 'Geri alma yolda — bittiğinde işlemler paneli söyleyecek',
  ...
  'toast.purged_partly_one': '{n} öğe kalıcı olarak silindi; {failed} öğe silinemedi',
  ...
  'coverage.catalog_failed': '{storage} kataloglanamadı: {error}',
