...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/screenshots/v0.41.2/explorer-grid-dark.png">
  <img src="docs/screenshots/v0.41.2/explorer-grid-light.png" alt="filex explorer — thumbnail grid" width="900">
</picture>
...
|---|---|
| ![Share modal](docs/screenshots/v0.41.2/share-modal.png) | ![Markdown viewer](docs/screenshots/v0.41.2/viewer-markdown.png) |

| Admin panel | Demo landing |
|---|---|
| ![Admin dashboard](docs/screenshots/v0.41.2/admin-dashboard.png) | ![Demo landing](docs/screenshots/v0.41.2/demo-landing.png) |

| The shell — what everybody lands on | Searching this folder; `⌘K` / `Ctrl K` hands the query to the palette |
|---|---|
| ![The filex shell](docs/screenshots/v0.41.2/driveshell/driveshell-hero-1440.png) | ![Searching a folder](docs/screenshots/v0.41.2/driveshell/driveshell-search-1440.png) |

| Navigation panel — Home, My files, Shared with me, Recent, Starred, Trash, and your storages | Collapsed to the icon rail |
|---|---|
| ![Navigation panel](docs/screenshots/v0.41.2/sidenav/sidenav-expanded-1440.png) | ![Collapsed to a rail](docs/screenshots/v0.41.2/sidenav/sidenav-rail-1440.png) |

| Shared with me — folders other people granted you, no mount instructions | Embedded in another product's page |
|---|---|
| ![Shared with me](docs/screenshots/v0.41.2/sidenav/view-shared-1440.png) | ![Embedded web component](docs/screenshots/v0.41.2/sidenav/embed-webcomponent-1440.png) |
...
|---|---|
| ![How to connect](docs/screenshots/v0.41.2/sidenav/connect-1440.png) | ![API keys](docs/screenshots/v0.41.2/sidenav/apikeys-minted-1440.png) |

| Reaching filex from anything — S3, SFTP, FTPS, NFS, WebDAV. Every command is built from *your* deployment |
|---|
| ![Connection guide](docs/screenshots/v0.41.2/connections-guide.png) |

| A storage filex does not ship — installed as a plugin, describing its own config form |
|---|
| ![Plugins](docs/screenshots/v0.41.2/admin-plugins.png) |
