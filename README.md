...
```bash
# Download from https://gitlab.com/brftech/filemanager/-/releases
./filex serve
```
...
- [Migration from `@brftech/file-explorer`](docs/MIGRATION.md)
