...
| | |
|---|---|
| ![Creating an encrypted folder](screenshots/v0.41.1/e2e-recovery/create-encrypted-folder.png) | ![The recovery key, shown once](screenshots/v0.41.1/e2e-recovery/recovery-key-shown-once.png) |
...
| ![The lock screen](screenshots/v0.41.1/e2e-recovery/locked-folder.png) | ![Unlocking with a recovery key](screenshots/v0.41.1/e2e-recovery/unlock-with-recovery-key.png) |
...
| ![The escrow tab](screenshots/v0.41.1/e2e-recovery/unlock-with-escrow-key.png) | ![The offer to a pre-v0.31 folder](screenshots/v0.41.1/e2e-recovery/legacy-folder-upgrade-offer.png) |
